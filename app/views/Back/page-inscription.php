    ...
    <!-- Espace titre -->        
        ...
        <div class="card-corps">        
            <table class="card-content">
                ...
                <tr class="bg-gold green">
                    <td class="label-formulaire green label-article"><label class="green label-article">Nom : </label></td>
                    <td class="input-formulaire"><input ></td>
                </tr>
                <tr class="bg-gold green">
                    <td class="label-formulaire green label-article"><label class="green label-article">Email: </label></td>
                    <td class="input-formulaire"><input></td>
                </tr>
                <tr class="bg-gold green">
