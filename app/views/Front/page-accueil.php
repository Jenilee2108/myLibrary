<?php ob_start(); ?>
    ...
    <section id="apropos" class="bloc-accueil">
        <article class="card">
         <!-- Image d'illustration -->
            <figure class="card-img"><img  src="/app/public/Front/images/" alt="MyLibrary vous souhaite la bienvenue dans votre bibliothèque de poche"></figure>
         <!-- Titre h1 en majuscules mais à la taille h2 -->
            <h1 class="h2 card-title"><span class="gold">MY</span>Library qu'est ce que c'est <span class="gold">?</span></h1>
         <!-- Mise en place d'une div pour faire le fond vert du text -->
            <div class="card-corps">
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Rerum expedita nisi itaque accusantium, ipsum ullam magnam quis! Magni sit repellat quaerat necessitatibus ullam blanditiis cum ipsa minus tempora. Necessitatibus, illum.
    ...
    <section id="fonctionnement" class="bloc-accueil icone-accueil">
        <h2 class="card-title"> comment cela fonctionne <span class="gold">?</span></h2>
     <!-- Mise en place d'une div contenant les icones avec mise en place de span entre les li pour mettre en place les chevrons en mode desktop -->
        <ol>
            <li class="icone"><img src="/app/public/Front/images/newCompte.png" alt="Je crée mon compte" class="icone"><p class="icone-text">Je crée mon compte</p></li>
                <span class="transition"></span>
            <li class="icone"><img src="/app/public/Front/images/ajoutLivre.png" alt="J'ajoute mes livres" class="icone"><p class="icone-text">J'ajoute mes livres</p></li>
                <span class="transition"></span>
            <li class="icone"><img src="/app/public/Front/images/blocMemo.png" alt="J'ajoute des memos" class="icone"><p class="icone-text">J'ajoute des memos</p></li>
                <span class="transition"></span>
            <li class="icone"><img src="/app/public/Front/images/loupe.png" alt="Je consulte MyLibrary depuis n'importe ou" class="icone"><p class="icone-text">Je consulte MyLibrary depuis n'importe ou</p></li>
        </ol>
    </section>
