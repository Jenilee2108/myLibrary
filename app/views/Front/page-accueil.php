<?php ob_start(); ?>
    ...
    <section id="apropos" class=" pagewidth container bloc-accueil">
        <article class="container-card card" id="quoi">
         <!-- Image d'illustration -->
            <figure class="img-accueil center card-img"><img  src="/app/public/Front/images/accueil.jpg" alt="MyLibrary vous souhaite la bienvenue dans votre bibliothèque de poche">
            </figure>
    ...
    <section id="fonctionnement" class="bloc-accueil icone-accueil">
     ...
     <!-- Mise en place d'une div contenant les icones avec mise en place de span entre les li pour mettre en place les chevrons en mode desktop -->
        <ol class="center">
            <li class="icone"><a href="inscription"><img src="/app/public/Front/images/newCompte.png" alt="Je crée mon compte" class="icone"></a>
            ...
            <p class="icone-text">J'ajoute des memos</p></li>
                <span class="transition"></span>
            <li class="icone"><a href="library"><img src="/app/public/Front/images/loupe.png" alt="J'ajoute des memos" class="icone"></a>
