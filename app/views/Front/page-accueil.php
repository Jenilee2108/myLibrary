...
<section id="fonctionnement" class="bloc-accueil icone-accueil">
    ...
    <ol class="center">
        <li class="icone">
            <a href="index.php?action=inscription"><img src="app/public/Front/images/newCompte.png" alt="Je crée mon compte" class="icone"></a>
            <p class="icone-text">Je crée mon compte</p>
        </li>

        <li class="icone">
            <img src="app/public/Front/images/ajoutLivre.png" alt="J'ajoute mes livres" class="icone">
            <p class="icone-text">J'ajoute mes livres</p>
        </li>

        <li class="icone">
            <img src="app/public/Front/images/blocMemo.png" alt="J'ajoute des memos" class="icone">
            <p class="icone-text">J'ajoute des memos</p>
        </li>

        <li class="icone">
            <a href="index.php?action=library"><img src="app/public/Front/images/loupe.png" alt="J'ajoute des memos" class="icone"></a>
            <p class="icone-text">Je consulte MyLibrary</p>
        </li>
    </ol>
</section>
