...
<section id="commentaire" class="container livreSolo">
    <div class="content-livre bg-gold">
        <h3 class="green label-article">Mon Commentaire : </h3>
        <p class="lightGray">
